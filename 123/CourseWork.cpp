    ...
    while (true)
    {
        ...
        case 3:
            while (Cont == 1)
            {
                ...
                cout << "Если вы хотите продолжить, введите 1. Для перехода к меню введите любое другое цифровое значение: ";
                cin >> BOARD;
                try
                {
                    Cont = stoi(BOARD);
